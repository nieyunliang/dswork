    ...
    <div className="flex h-[288px] w-full max-w-95 flex-col self-start overflow-hidden rounded-[14px] bg-surface shadow-card">
      ...
      <div className="flex shrink-0 items-center justify-between border-b border-line p-1.5">
        ...
        <div className="flex items-center gap-1">
          {[
            { label: "新建", icon: <path d="M12 5v14M5 12h14" /> },
            { label: "历史记录", icon: <g><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /></g> },
            { label: "更多", icon: <g fill="currentColor" stroke="none"><circle cx="5" cy="12" r="1.8" /><circle cx="12" cy="12" r="1.8" /><circle cx="19" cy="12" r="1.8" /></g> },
          ].map(({ label, icon }) => (
            <button
              key={label}
              type="button"
      ...
      <div aria-live="polite" className="flex min-h-0 flex-1 flex-col gap-2.5 overflow-y-auto px-3 pt-2.5 pb-1">
